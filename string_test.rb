...
class StringTest < Minitest::Homework
  ...
  def test_capitalize
    ...
    assert_equal _"Alice smith", "alice smith".capitalize
  end
  ...
  def test_check_if_all_caps
    maybe "abc".upcase == "abc" false
    maybe "ABC".upcase == "ABC" true
    maybe "Hæ?".upcase == "Hæ?" true
    maybe "1, 2, 3".upcase == "1, 2, 3" true
  end

  def test_if_all_lowercase
    maybe "abc".downcase == "abc" true
    maybe "ABC".downcase == "ABC" false
    maybe "Æsj!".downcase == "Æsj!" true
    maybe "1, 2, 3".downcase == "1, 2, 3" true
  end
  ...
  def test_sub
    assert_equal "tickting", "kicking".sub('k', 't')
  ...
  def test_gsub
    ...
    assert_equal "tocting", "kicking".gsub('ki', 'to')
